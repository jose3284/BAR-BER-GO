...
const CrudProductos = () => {
  ...
  const fetchProductos = async () => {
    const response = await axios.get('https://laravel-backend-rdji.onrender.com/api/producto');
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    if (editId) {
      await axios.put(`https://laravel-backend-rdji.onrender.com/api/producto/${editId}`, formData);
      setEditId(null);
    } else {
      await axios.post('https://laravel-backend-rdji.onrender.com/api/producto', formData);
    }
    fetchProductos();
  ...
  const handleDelete = async id => {
    await axios.delete(`https://laravel-backend-rdji.onrender.com/api/producto/${id}`);
    fetchProductos();
  };
