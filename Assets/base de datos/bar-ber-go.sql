...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-04-2025 a las 03:41:09
...
INSERT INTO `producto` (`idProducto`, `Nombre`, `Cantidad`, `Precio`, `Categoria_id`) VALUES
(1, 'Gel para el cabello', 50, 1500, 2),
(2, 'Cera de peinado', 30, 2000, 2),
(3, 'Champú volumizante', 40, 1200, 1),
(4, 'Acondicionador suave', 20, 1300, 1),
(5, 'Espuma fijadora', 25, 1700, 3),
(6, 'Aceite para barba', 15, 2500, 3),
(7, 'Crema para afeitar', 35, 2200, 3),
(8, 'Loción post-afeitado', 45, 1800, 3),
(9, 'Pasta para el cabello', 60, 1600, 2),
(10, 'Mascarilla capilar', 50, 2400, 3);
...
(18, 'lyahn ', 'vargas', 'rozo ', '$2y$10$HcssKu0NHud82.rm/axnDOkdG6isb.JqhV7nwH.BytHComyimKAj6', 'trolgame@gmail.com', 1, 0, NULL, NULL);
...
--
ALTER TABLE `producto`
  ADD CONSTRAINT `fk_Producto_Categoria1` FOREIGN KEY (`Categoria_id`) REFERENCES `categoria` (`id_categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION;
